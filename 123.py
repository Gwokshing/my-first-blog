...
# web application at http://Gwokshing.pythonanywhere.com/
...
#import sys
#
#path = '/home/Gwokshing/path/to/my/app
#if path not in sys.path:
#    sys.path.append(path)
#
...
#import sys
#
## assuming your django settings file is at '/home/Gwokshing/mysite/mysite/settings.py'
## and your manage.py is is at '/home/Gwokshing/mysite/manage.py'
#path = '/home/Gwokshing/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
#os.environ['DJANGO_SETTINGS_MODULE'] = 'mysite.settings'
...
#import sys
#
## The "/home/Gwokshing" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/Gwokshing/myproject"
#path = '/home/Gwokshing/path/to/flask_app_directory'
#if path not in sys.path:
#    sys.path.append(path)
#
